...
from PySide2.QtCore import QByteArray, Signal
...
class ToggleSwitch(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None, w1="ON", l1=12, w2="OFF", l2=33, width=60, anim_duration=100):
    ...
    def mousePressEvent(self, event=None):
        ...
        self.__circlemove = QtCore.QPropertyAnimation(self.__circle, QByteArray(b"pos"))
        self.__circlemove.setDuration(self.__duration)

        self.__ellipsemove = QtCore.QPropertyAnimation(self.__background, QByteArray(b"size"))
        ...
        getattr(self, "toggled").emit(self.__value)
